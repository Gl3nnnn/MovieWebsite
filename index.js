const apiKey = "6f4fcc5f1de75aa20ce2d1dff3c471f8";
...
function createMovieCard(movie) {
    const { poster_path, original_title, release_date, overview, vote_average, genre } = movie;
    ...
    const rating = vote_average ? `Vote average: ${vote_average}/10` : "No rating yet";
    const genreString = genre ? genre.join(", ") : "No genre yet";
    
    // Here's the card template with the overview included
    const cardTemplate = `
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-header">
                    <div class="left-content">
                        <h3 style="font-weight: 600; color: white">${truncatedTitle}</h3>
                        <span style="color: #12efec">${formattedDate}</span>
                        <span style="color: white">${rating}</span>
                        <span style="color: white">${genreString}</span>
                    </div>
                </div>
                <!-- Overview section -->
